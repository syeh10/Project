          ...
          if (mysqli_num_rows($result)> 0)
          {
            ...
            while($row = $result->fetch_assoc())
            {
              ...
              <td class="product_box">
                <div>
                  <h1><?php echo $row['name'] ?> <span><?php echo $row['author'] ?></span></h1>
                  <!-- The photo of a book -->
                  ...
                  <div class="product_info">
                    ...
                    <input type='submit' value='Edit' onclick='editBookClick($book_id);'>
                    <input type='submit' value='Delete' onclick='deleteBookClick($book_id);'>
                  </div>
                </div>
              </td>
              <?php
